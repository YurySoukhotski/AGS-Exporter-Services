...
import com.example.eximporter.exporter.model.api.Box;
import com.example.eximporter.exporter.model.api.Peo;
import com.example.eximporter.exporter.model.api.ProjectLink;
import com.example.eximporter.exporter.model.api.ProjectRequest;
...
import static com.example.eximporter.exporter.helper.MappingAttributeHelper.ATTR_AGS_ART_DEF_FP_ID;
import static com.example.eximporter.exporter.helper.MappingAttributeHelper.ATTR_SEITE_FP_ID;
import static com.example.eximporter.exporter.helper.MappingAttributeHelper.PLACEMENT_ID_IDENTIFIER;
...
public class PeoApiService extends BaseApiService {
    ...
    public Peo[] searchPeoByPageIdAndFpId(String peoFpId, String pageFpId) throws RestException {
        String query = String
                .format(SEARCH_PEO_QUERY, commonConfiguration.getPeoTemplateName(), PLACEMENT_ID_IDENTIFIER, peoFpId, PROJECT_QUERY_PREFIX + ATTR_SEITE_FP_ID,
                        pageFpId);
    ...
    public Peo[] searchPeoByFpId(String peoFpId) throws RestException {
        String query = String.format(SEARCH_PEO_BY_ID_QUERY, commonConfiguration.getPeoTemplateName(), PLACEMENT_ID_IDENTIFIER, peoFpId);
        return searchPeo(query);
    }
    ...
    public Peo[] searchByArticleFpIdAndPageFpId(String articleFpId, String pageFpId) throws RestException {
        String query = String.format(SEARCH_PEO_QUERY, commonConfiguration.getPeoTemplateName(), PRODUCT_QUERY_PREFIX + ATTR_AGS_ART_DEF_FP_ID, articleFpId,
                PROJECT_QUERY_PREFIX + ATTR_SEITE_FP_ID, pageFpId);
        return searchPeo(query);
    }
